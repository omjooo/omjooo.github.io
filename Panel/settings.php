	    ...
	    <div class="col-lg-6">
		  ...
		  <hr />
		    ...
		    <div class="form-group">
              ...
              <div class="col-lg-8">
                <input type="text" class="form-control" id="dbpassword" name="dbpassword" value="" placeholder="留空则不修改">
              </div>
            </div>
		    <div class="form-group">
		...
		<div class="col-lg-6">
		  <div style="margin: 0px 60px 0px 0px;">
		    ...
		    <div class="form-group">
              ...
              <div class="col-lg-8">
                <input type="text" class="form-control" id="password" name="password" placeholder="留空则不修改">
              </div>
            </div>
			<hr />
		    <div class="form-group">
...
<option value="Pacific/Kiritimati">(GMT+14:00) Kiritimati</option>
		    ...
		    <div class="form-group">
              ...
              <div class="col-lg-7">
				...
				<button type="button" onClick="window.location='clearmessages.php'" class="btn btn-default btn-small btn-block">清空历史记录表</button>
				<button type="button" onClick="window.location='clearawaiting.php'" class="btn btn-default btn-small btn-block">清空待执行命令</button>
              </div>
            </div>
			<br />
			<button type="submit" class="btn btn-primary btn-small btn-block">保存设置</button>
			<button type="button" onClick="window.location='control.php'" class="btn btn-default btn-small btn-block">退出不保存</button>
		  </div>
		</div>
	  </form>
	</div>
